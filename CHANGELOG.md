...
### Fixed
- Claude: price the documented Kimi `k3[1m]` context alias in local usage reports without changing model names or mixing provider catalogs; refresh affected Pi costs while preserving native Codex caches (investigated alongside #2374). Thanks @joeVenner!

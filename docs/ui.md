...
- Token/cost, credit-usage breakdown, and plan-history chart date labels retain their full text width in narrow menus.
  Plan history also reserves plot-edge space

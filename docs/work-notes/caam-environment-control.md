...
- Repository CI also passed SwiftLint, release builds and CLI smoke tests on Linux x64 and ARM64, and the static Linux-musl build at implementation head `d9db8915fa23beead7d2beb58fb4472b5d0b7a55`. The aggregate gate intentionally remains incomplete while the macOS test job is deferred for a draft PR.
